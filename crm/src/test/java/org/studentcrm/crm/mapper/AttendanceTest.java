...
import org.studentcrm.crm.controller.AttendanceRestController;
...
public class AttendanceTest {
	...
	@Autowired
	private AttendanceRestController controller;
    ...
    public void insertMemo() {
        LocalDate DateFromDB = LocalDate.now();
    ...
    public void updateStatus() {
	   ...
	   vo.setS_id(num);
	   LocalDate time = getTime(num).get(0);
	   log.info(time);
	   vo.setA_date(time);
